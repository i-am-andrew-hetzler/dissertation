...
function installLicensingChaincode() {
  ...
  commitChaincode wv-dmv-peer0 commitLicensingChaincode "insurer-co-wv-peer0:2851"
}
...
function start() {
  ...
  case "$network" in
    ...
    registration)
      ...
      joinRegistrationPeersToChannel
      updateRegistrationAnchorPeers
      installRegistrationChaincode
      ;;
  esac
