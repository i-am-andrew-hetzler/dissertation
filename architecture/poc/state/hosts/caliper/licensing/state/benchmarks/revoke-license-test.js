...
class IssueLicenseWorkloadModule extends WorkloadModuleBase {
    ...
    async submitTransaction() {
        ...
        const request2 = {
            contractId: this.roundArguments.contractId,
            contractFunction: 'revokeLicense',
            invokerIdentity: 'User1@dmv.sd.gov',
...
// peer chaincode invoke  -o ${ORDERER_ADDRESS}:${ORDERER_PORT} --tls --cafile /etc/hyperledger/fabric/orderer/tls/ca.crt --peerAddresses ${PEER_ADDRESS}:${PEER_PORT} --tlsRootCertFiles /etc/hyperledger/fabric/tls/ca.crt -C licensing -n licensing-chaincode -c '{"function": "revokeLicense", "Args":["OH-123"]}'
